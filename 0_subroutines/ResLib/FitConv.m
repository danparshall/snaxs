function [pa,dpa,chisqN,sim,CN,PQ,nit,kvg,details]=...
   FitConv(H,K,L,W,EXP,Iobs,dIobs,sqw,pref,pa,ia,METHOD, ACCURACY,nitmax,tol,dtol)
%==================================================================================
%  function [pa,dpa,chisqN,sim,CN,PQ,nit,kvg,details]=...
%   FitConv(H,K,L,W,EXP,Iobs,dIobs,sqw,pref,pa,ia,METHOD, ACCURACY,nitmax,tol,dtol)
%
%  ResLib v.3.4
%==================================================================================
% Fit a user-supplied parametrized model cross section function convoluted with the
...
% analytic derivatives. See manual for details.
%
...
%----------------------------------------------------------------------------------------------------------------
if (nargout>=8)
    sim = ConvRes(sqw,pref,H,K,L,W,EXP,METHOD,ACCURACY,pa);
...
for n=1:length(ivar) %loop through varying parameters
   ...
   pa1=pa+h;
   pa2=pa-h;
   f1=ConvRes(sqw,pref,H,K,L,W,EXP,METHOD,ACCURACY,pa1);GLOBAL_FUNCOUNT____=GLOBAL_FUNCOUNT____+1;
   f2=ConvRes(sqw,pref,H,K,L,W,EXP,METHOD,ACCURACY,pa2);GLOBAL_FUNCOUNT____=GLOBAL_FUNCOUNT____+1;
...
global GLOBAL_FUNCOUNT____
   f=ConvRes(sqw,pref,H,K,L,W,EXP,METHOD,ACCURACY,pa); GLOBAL_FUNCOUNT____=GLOBAL_FUNCOUNT____+1;
