...
pause(0.1);
figure(1);clf;
I11=ConvRes('SqwDemo',[],H1,K1,L1,W1,setup,'fix',[5 0],p); %'PrefDemo' instead of []
...
pause(0.1);
I12=ConvRes('SqwDemo',[],H1,K1,L1,W1,setup,'fix',[15 0],p);
...
pause(0.1);
I13=ConvRes('SqwDemo',[],H1,K1,L1,W1,setup,'mc',[],p);
...
fprintf('Hit any key to start...');
pause;
I14=ConvResSMA('SMADemo',[],H1,K1,L1,W1,setup,'fix',[15 0],p);
...
fprintf('Hit any key to start...');
pause;
I15=ConvResSMA('SMADemo',[],H1,K1,L1,W1,setup,'mc',[1],p);
