...
%RANGE=[3.0 3.3, -0.3 0, -4 4];
RANGE=[1 3, -1 1, -1 5];

% Define a mesh of (x,y) points for ploting the dispersion surface.
SX=linspace(RANGE(1),RANGE(2),20);
SY=linspace(RANGE(3),RANGE(4),20);
...
figure(1); clf;
ResPlot3D_JUNK(H,K,L,W,setup,RANGE,'Yellow','r','r','r','SMADemo_test',p,SXg,SYg);
